...
function unifyBranding() {
    ...
    if (navContainer) {
        navContainer.innerHTML = `
            ...
            </li>`r`n            <li><a href="japan_evisa.html" style="position: relative;">`r`n                <span class="nav-en">e-Visa (COE)<span style="position: absolute; top: -3px; right: -8px; width: 6px; height: 6px; background-color: var(--secondary-color); border-radius: 50%;"></span></span>`r`n                <span class="nav-kr">?쇰낯 ?꾩옄鍮꾩옄(?щ쪟?먭꺽)</span>`r`n            </a></li>`r`n            <li><a href="japan_evisa.html" style="position: relative;">`r`n                <span class="nav-en">e-Visa (COE)<span style="position: absolute; top: -3px; right: -8px; width: 6px; height: 6px; background-color: var(--secondary-color); border-radius: 50%;"></span></span>`r`n                <span class="nav-kr">?쇰낯 ?꾩옄鍮꾩옄(?щ쪟?먭꺽)</span>`r`n            </a></li>
            <li>
