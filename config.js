...
const DEFAULT_CONFIG = {
    ...
    fees: {
        ...
        'taiwan': {
            'Work (취업-단수)': { 'Standard (보통-7일)': 160000, 'Express (급행-3일)': 200000 },
            'Work (취업-복수)': { 'Standard (보통-7일)': 270000, 'Express (급행-3일)': 360000 },
            'Student (유학)': { 'Standard (보통)': 70000 }
        },
        'vietnam': {
            'e-Visa (90일단수)': { 'Normal (보통)': 90000, 'Express (급행)': 200000, 'Urgent (긴급)': 290000 },
            'e-Visa (90일복수)': { 'Normal (보통)': 120000, 'Express (급행)': 240000, 'Urgent (긴급)': 320000 },
            '대사관비자 단수 (1~3개월)': { 'Normal (5박6일)': 90000, 'Express (1박2일)': 100000, 'Urgent (당일)': 120000 },
            '대사관비자 단수 (4~48개월)': { 'Normal (5박6일)': 130000, 'Express (1박2일)': 140000, 'Urgent (당일)': 190000 },
            '대사관비자 복수 (1개월)': { 'Normal (5박6일)': 120000, 'Express (1박2일)': 130000, 'Urgent (당일)': 150000 },
            '대사관비자 복수 (2~6개월)': { 'Normal (5박6일)': 190000, 'Express (1박2일)': 220000, 'Urgent (당일)': 250000 },
            '대사관비자 복수 (7~12개월)': { 'Normal (5박6일)': 250000, 'Express (1박2일)': 300000, 'Urgent (당일)': 350000 },
            '대사관비자 복수 (13~24개월)': { 'Normal (5박6일)': 360000, 'Express (1박2일)': 430000, 'Urgent (당일)': 480000 },
            '대사관비자 복수 (25~48개월)': { 'Normal (5박6일)': 460000, 'Express (1박2일)': 550000, 'Urgent (당일)': 620000 }
        }
    },
    notices: [
